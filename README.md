...
Aqui, está o projeto desenvolvido para o processo seletivo da _NG.CASH_!
...
1️⃣ **Banco de dados:**
  - Será um container docker PostgreSQL já configurado no docker-compose através de um serviço definido como `db`.
  - Tem o papel de fornecer dados para o serviço de _backend_.
  - É acessado pela _ORM_ `sequelize` e via porta `3002` do `localhost`.

2️⃣ **Back-end:**
 - Também conhecida como `API`, se comunica com o banco para **criar**, **manipular** e **ler** suas informações;
 - Roda na porta `3001`, pois o front-end faz requisições para ele nessa porta por padrão;
 - Foi desenvolvida em `Node.js` + `TypeScript` utilizando o `express`

3️⃣ **Front-end:**
  - É o que o usúario vê e interage;
  - O front se comunica com serviço de back-end pela url `http://localhost:3001` e roda na porta `3000`.

4️⃣ **Docker:**
  - O `docker-compose` tem a responsabilidade de unir todos os serviços conteinerizados (backend, frontend e db) e subir o projeto completo.
